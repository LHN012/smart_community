Component({
  ...
  methods: {
    ...
    initByOldWay(callback) {
      ...
      const canvas = new WxCanvas(this.ctx, canvasId, false, this);
    ...
    initByNewWay(callback) {
      ...
      query.select('.ec-canvas')
        ...
        .exec(res => {
          ...
          if (typeof callback === 'function') {
            this.chart = callback(canvas, res[0].width, res[0].height, canvasDpr);
          } else if (this.data.ec && typeof this.data.ec.onInit === 'function') {
            this.chart = this.data.ec.onInit(canvas, res[0].width, res[0].height, canvasDpr);
          } else {
            this.triggerEvent('init', {
              canvas: canvas,
              width: res[0].width,
